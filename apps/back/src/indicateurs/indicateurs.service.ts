...
WHERE RTRIM(steu.steu_sandre_cda) IN ($1);
    ...
    // Note: TypeORM doesn't support arrays for positional parameters in raw SQL easily with PostgreSQL's IN clause
    // when using $1. We might need to generate ($1, $2, ...)
    ...
    return results.map((r: any) => ({
      ...
      pc95Retenu: Number(r.pc95_retenu),
