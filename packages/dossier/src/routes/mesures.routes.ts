...
export const listPointsMesure = {
  ...
  response: z.array(
    z.object({
      identifiantPointMesure: z.number(),
      numeroPointMesure: z.string(),
...
export const listFinalites = {
  ...
  response: z.array(
    z.object({
      codeElementNomenclature: z.string(),
      libelleElementNomenclature: z.string().nullable(),
    }),
  ),
} as const satisfies RouteDefinition;
